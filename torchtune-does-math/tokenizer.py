...
DEFAULT_DEEPSEEK_TOKENIZER_BPE_CACHE_SIZE = 100002
...
class DeepSeekTokenizer(ModelTokenizer):
    """This class construct a DeepSeek tokenizer, based on GPT-2 byte-level BPE tokenization.
    ...
    Args:
        ...
        bpe_cache_size (int): BPE token cache size in DeepSeekTokenizer.
            ...
            By default, we set the cache size equals to size of the official DeepSeek tokenizer.

    Example:
        >>> tokenizer = DeepSeekTokenizer(path="/path/to/vocab.json", merges_file="/path/to/merges.txt")
    ...
    def __init__(
        ...
        *,
        ...
        pad_token: Optional[str] = EOS_TOKEN,
        bpe_cache_size: int = DEFAULT_DEEPSEEK_TOKENIZER_BPE_CACHE_SIZE,
    ):
        ...
        self.special_tokens = (
            special_tokens if special_tokens is not None else DEEPSEEK_SPECIAL_TOKENS
        )
        ...
        self.prompt_template = _get_prompt_template(prompt_template)
